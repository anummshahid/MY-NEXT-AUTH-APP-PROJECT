...
// Server-only dynamic page - no client-side code
interface Post {
  id: number
  title: string
  body: string
...
// Server-side data fetching function using dynamic id
...
export default async function DynamicPage({
  ...
  // Extract dynamic id parameter
  const { id } = await params

  // Server-side data fetching using the dynamic id
